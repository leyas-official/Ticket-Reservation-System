                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                    @foreach ($events as $event)
                        <div class="box flex flex-col bg-white shadow-md rounded-xl p-6 transition-all duration-300 hover:shadow-lg group hover:-translate-y-1 cursor-pointer">
                            ...
                            @auth
                                @php
                                    // Convert the tickets collection to an array of event IDs
                                ...
                                @else
                                    <a href="{{ route('addToCart', [$event->id , Auth::user()->id ]) }}" class="mt-6 inline-block text-center text-white bg-blue-800 hover:bg-blue-900 font-medium py-2 px-6 rounded-lg transition-colors duration-200">
                                        Add To Cart
                                    </a>
                                @endif
                                ...
                                @endauth
                            @guest
                                <a href="{{ route('login') }}" class="mt-6 inline-block text-center text-white bg-blue-800 hover:bg-blue-900 font-medium py-2 px-6 rounded-lg transition-colors duration-200">
                                    Add To Cart
                                </a>
                            @endguest
                        </div>
