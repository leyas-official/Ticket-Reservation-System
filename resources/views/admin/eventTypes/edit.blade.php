...
<div class="max-w-xl mx-auto mt-40 bg-white rounded-xl shadow-md p-8">
    <h2 class="text-3xl font-bold text-center text-green-700 mb-6">Edit Event Type</h2>
    <form action="{{ route('admin.eventTypes.update',$eventType->id) }}" method="POST" class="space-y-6">
        @csrf
        @method('PUT')
        <div>
            ...
            <input type="text" id="name" name="name" required
                   ...
                   placeholder="Enter Name Event" value="{{ $eventType->name }}">
            @error('name')
